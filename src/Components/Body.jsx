...
const Body = () => {
  return (
    <div className="space-y-4 lg:flex">
      <div className="flex item-center justify-center lg:flex-1 lg:h-[400px] lg:order-2 lg:justify-end">
      ...
      <div className="lg:flex-1 lg:order-1">
        ...
        <p className="font-lato text-gray-400 "> With Hoster , got your website up and running in no less than 5 minutes with the most competitive pricing packages  in the industry. </p>
        ...
        <div className="flex gap-2">
            ...
            <p className="font-lato text-gray-400">Lorem, ipsum dolor sit amet elit.</p>
        </div>
      </div>
    </div>
  );
